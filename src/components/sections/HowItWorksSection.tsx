    ...
    <section className="pb-10">
      <div className="">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card
            ref={card1.ref}
            className={`text-center p-8 border-2 border-secondary/30 bg-card/20 backdrop-blur-sm hover:border-primary hover:shadow-[0_0_30px_rgba(240,177,220,0.3)] transition-all duration-700 ${card1.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <CardContent className="pt-6">
              ...
              <div className="flex justify-center mb-4">
                <video
                  ...
                  loop
                  playsInline
                  className="w-16 h-16 rounded-full object-cover shadow-[0_0_20px_rgba(240,177,220,0.4)]"
                />
              </div>
          ...
          <Card
            ref={card2.ref}
            className={`text-center p-8 border-2 border-secondary/30 bg-card/20 backdrop-blur-sm hover:border-primary hover:shadow-[0_0_30px_rgba(240,177,220,0.3)] transition-all duration-700 delay-150 ${card2.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <CardContent className="pt-6">
              <div className="flex justify-center mb-6">
                <div className="w-20 h-20 bg-secondary/20 rounded-full flex items-center justify-center border border-secondary/50">
          ...
          <Card
            ref={card3.ref}
            className={`text-center p-8 border-2 border-secondary/30 bg-card/20 backdrop-blur-sm hover:border-primary hover:shadow-[0_0_30px_rgba(240,177,220,0.3)] transition-all duration-700 delay-300 ${card3.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <CardContent className="pt-6">
              <div className="flex justify-center mb-6">
                <div className="w-20 h-20 bg-secondary/20 rounded-full flex items-center justify-center border border-secondary/50">
