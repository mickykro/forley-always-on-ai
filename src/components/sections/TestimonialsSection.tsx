        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="p-6 bg-card/20 backdrop-blur-sm border-2 border-primary/30 hover:shadow-[0_0_25px_rgba(240,177,220,0.3)] hover:border-primary transition-all">
            <CardContent className="pt-4">
              ...
              <p className="text-foreground italic">
                "פורלי חסכה לנו שעות של עבודה יומית. המערכת חכמה, נוחה ומשדרגת את השירות שלנו בצורה משמעותית."
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="p-6 bg-card/20 backdrop-blur-sm border-2 border-primary/30 hover:shadow-[0_0_25px_rgba(240,177,220,0.3)] hover:border-primary transition-all">
            <CardContent className="pt-4">
              ...
              <p className="text-foreground italic">
                "ההשקעה הכי חכמה שעשיתי השנה. פורלי הפכה כל שיחה לעסק, ואני יכול להתמקד במה שאני הכי טוב בו."
              </p>
            </CardContent>
          </Card>
        </div>
