...
const objectionHighlights = [
  {
    ...
    description: "פורלי עונה עבורך, שולחת ווטסאפ אישי ללקוח ומעדכנת אותך – בלי לפספס שיחות.",
  },
  {
  ...
  },
  {
    ...
    description: "פורלי שומרת על קשר עם הלקוח, מגיבה מיידית – ואתה לא מאבד את הליד.",
  },
];
