  ...
  return (
    <section className="py-20">
      <div className="px-4 text-center">
        ...
        <Card className="max-w-md mx-auto bg-card/30 backdrop-blur-sm border-2 border-primary/30 text-foreground p-8 shadow-[0_0_30px_rgba(255,0,255,0.2)]">
            ...
            <div className="space-y-4 text-right">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border-2 border-primary/30 rounded-lg text-center bg-card/50 backdrop-blur-sm text-foreground focus:outline-none focus:border-primary focus:shadow-[0_0_15px_rgba(255,0,255,0.4)] transition-all"
                />
              </div>
              <div>
