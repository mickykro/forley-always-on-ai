    ...
    <section id="pricing" className="py-20">
      <div className="px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="p-8 border-2 border-primary/50 bg-card/20 backdrop-blur-sm shadow-[0_0_40px_rgba(240,177,220,0.3)] relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <Badge className="bg-primary text-black shadow-[0_0_15px_rgba(240,177,220,0.6)]">הכי פופולרי</Badge>
            </div>
            <CardContent className="pt-4">
              <div className="text-center mb-8">
              ...
              <Button
                type="button"
                className="w-full bg-primary text-black hover:bg-primary/90 hover:shadow-[0_0_30px_rgba(240,177,220,0.6)]"
                onClick={onOpenContact}
              >
                התחילו עכשיו
              </Button>
